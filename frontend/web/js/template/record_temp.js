...
var record_ctl = {
    ...
    loadRecordHtml : function(model){
        ...
        if(this.type == 1 && model.pub_username != undefined){
            ...
            name_href = "/talent/default/view/" + model.pub_uid;
        }
        else if(this.type == 2){
            if(model.bid_username1 != undefined){
                name = model.bid_username1;
                name_href = "/talent/default/view/" + model.bid_uid1;
            }
            else{
                name = model.bid_username;
                name_href = "/talent/default/view/" + model.bid_uid;
            }
        ...
        var html ='<tr>\
                        ...
                        <td class="color-gray">' + model.sub_time + '</td>\
                    </tr>';
        return html;
    },
    /**
