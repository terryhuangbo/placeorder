...
$(".list-bar-link").on("click",function(){
    $(this).addClass("active");
    $(".list-block-link").removeClass("active");
    $(".list-bar").addClass("hidden");
    $(".list-block").removeClass("hidden");
});
$(".list-block-link").on("click",function(){
    $(this).addClass("active");
    $(".list-block").addClass("hidden");
    $(".list-bar").removeClass("hidden");
    $(".list-bar-link").removeClass("active");
});