	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" method="post" class="order_post_form" action="http://www.xdzk.net/index.php?m=home&amp;c=order&amp;a=add&amp;id=1260&amp;goods_type=135">
						<ul>
						<li><span class="fixed-width-right-80">QQ号码：</span><input name="qq" type="text" placeholder="请输入QQ号码"></li>
													<li><span class="fixed-width-right-80">下单数量：</span><input name="need_num_0" type="text" placeholder="范围1000-10000000之间"></li>						  <input type="hidden" name="goods_id" value="1260">
