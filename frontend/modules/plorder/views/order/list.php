        ...
        <?php if(!empty($order['goods'])): ?>
            <div class="box" oid="<?php echo $order['oid'] ?>">
                ...
                <div class="text">
                    ...
                    <div>
                        <div class="integral">积分&nbsp;&nbsp;<span><?php echo getValue($order, 'goods.plorder_pionts', 0) ?></span></div>
                        <div class="count">
        ...
        <div class="address-container">
            <div class="address">
                <?php if(!empty($order['address'])): ?>
                    ...
                    <a href="/plorder/address/change-order-address?oid=<?php echo $order['oid'] ?>"><div class="change" oid="<?php echo $order['oid'] ?>">更换地址</div></a>
                <?php else: ?>
                    <a href="/plorder/address/change-order-address?oid=<?php echo $order['oid'] ?>"><div class="change" oid="<?php echo $order['oid'] ?>">添加地址</div></a>
                <?php endif ?>
            </div>
        </div>
    <?php endforeach ?>
...
<script>
    $(".paynow").on('click', function(){
        ...
        var param = {oids: oids};
        $._ajax('/plorder/order/pay', param, 'POST', 'JSON', function(json){
            if(json.code > 0){
                window.location.href = '/plorder/my/order';
            }else{
                $alarr = [-20003];
