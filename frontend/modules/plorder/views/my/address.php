        ...
        <?php foreach($list as $add): ?>
            <li>
                ...
                <div class="middle">
                    ...
                    <span class="edit"><a href="/plorder/address/update?uid=<?php echo $uid ?>&add_id=<?php echo $add['add_id'] ?>"><img src="/images/icon05.png"></a></span>
                </div>
                <div class="bottom">地址类型：<?php echo $add['type_name'] ?></div>
            </li>
        <?php endforeach ?>
    </ul>
    <div class="button"><a href="/plorder/address/add?uid=<?php echo $uid ?>" class="btn">新增地址</a></div>
</div>
</body>
<!--微信分享-->
