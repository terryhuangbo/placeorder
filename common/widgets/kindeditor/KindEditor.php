...
class KindEditor extends InputWidget {
    ...
    public function run() {
        ...
        if ($this->hasModel()) {
            ...
            switch ($this->editorType) {
                case 'uploadButton':
                    return Html::input('text', $this->name, $this->value, ['id' => $this->id, 'readonly' => "readonly"]) . '<input type="button" id="uploadButton" value="Upload" />';
                    break;
                case 'colorpicker':
                    return Html::input('text', $this->name, $this->value, ['id' => $this->id]) . '<input type="button" id="colorpicker" value="打开取色器" />';
                    break;
                case 'file-manager':
                    return Html::input('text', $this->name, $this->value, ['id' => $this->id]) . '<input type="button" id="filemanager" value="浏览服务器" />';
                    break;
                case 'image-dialog':
                    return Html::input('text', $this->name, $this->value, ['id' => $this->id]) . '<input type="button" id="imageBtn" value="选择图片" />';
                    break;
                case 'file-dialog':
                    return Html::input('text', $this->name, $this->value, ['id' => $this->id]) . '<input type="button" id="insertfile" value="选择文件" />';
                    break;
...
EOT;
            ...
            default:
                ...
                options.afterBlur = function(){this.sync();};
	var Keditor = K.create('#" . $this->id . "', options);
});";
                break;
        }
