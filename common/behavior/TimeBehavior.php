...
{
    /**
     * @var array the attribute that will receive timestamp value
    ...
    public function init()
    {
        ...
        if (empty($this->attributes)) {
            $this->attributes = [
                BaseActiveRecord::EVENT_BEFORE_INSERT => array_unique(array_merge($this->create, $this->update)),
                BaseActiveRecord::EVENT_BEFORE_UPDATE => $this->update,
            ];
        }
    }
