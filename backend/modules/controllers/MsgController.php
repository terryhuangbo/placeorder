...
class MsgController extends CommonWebController
{
    ...
    {
        return ['login', 'sendmsg', 'msg', 'read', 'mysend', 'reply', 'pull'];
    }
    ...
    public function actionMysend()
    {
        ...
        $page = new Pagination(['defaultPageSize' => yii::$app->params['page_size'], 'totalCount' => $count]);
        $msgs = $model->find()->where(['fid' => $uid])->orderBy('send_time desc')->offset($page->offset)->limit(
            $page->limit
        )->all();
