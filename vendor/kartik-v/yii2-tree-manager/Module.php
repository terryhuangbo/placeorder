...
class Module extends \kartik\base\Module
{
    ...
    public function init()
    {
        ...
        $nodeActions += [
            self::NODE_MANAGE => Url::to(['/industry/industry/manage']),
            self::NODE_SAVE => Url::to(['/industry/industry/save']),
            self::NODE_REMOVE => Url::to(['/industry/industry/remove']),
            self::NODE_MOVE => Url::to(['/industry/industry/move']),
        ];
